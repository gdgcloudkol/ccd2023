    ...
    <footer className="p-4 bg-white sm:p-6">
      ...
      <div className="sm:flex sm:items-center sm:justify-center">
        <div className="flex justify-center mt-4 space-x-6 sm:justify-center sm:mt-0">
          <a href="https://facebook.com/gdgcloudkol" target="__blank">
            <SiFacebook />
          </a>
          <a href="https://instagram.com/gdgcloudkol" target="__blank">
            <SiInstagram />
          </a>
          <a href="https://twitter.com/gdgcloudkol" target="__blank">
            <SiTwitter />
          </a>
          <a
          ...
          <a href="https://github.com/gdgcloudkol" target="__blank">
            <SiGithub />
          </a>
          {/* <a
