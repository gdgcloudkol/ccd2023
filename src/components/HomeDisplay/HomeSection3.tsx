  ...
  return (
    <div className="hidden lg:block h-44 -mt-120">
      <div className="grid grid-cols-4 text-white text-left">
        <div className={`event-sec-3 text-black pl-32 pr-32 pt-5 ${CurrentTheme() === DARK ? 'strokeme-w text-black ' : ' strokeme text-white'}`}>
          {landingPageContent?.subTitle2}
          <p
            className={`no-shadow ${CurrentTheme() === DARK ? 'text-white' : 'text-black'
              }`}
          >
