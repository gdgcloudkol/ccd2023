...
const FaqPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>FAQs | Google Cloud Community Days Kolkata 2023</title>
        <meta
          name="description"
          content="Some of the frequently asked questions about Google Cloud Community Days Kolkata 2023"
        />
      </Helmet>
          ...
          <div>
            <p
              ...
              dangerouslySetInnerHTML={{
                __html: content?.description?.substring(3)
              }}
            ></p>
          </div>
        </div>
